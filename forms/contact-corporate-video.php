...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "Corporate Video Landing page - ".$from_name;
    ...
    // Add BCC header
    // $headers .= "Bcc: imtiyazshamim@gmail.com";
...
function sendDataToGoogleSheet($formData) {
    $url = 'https://script.google.com/macros/s/AKfycbwmXjsHvTupa5I56ehq6nLMv7g8JbGmvx1tLinCWg3rsHHUBV3UVmNwSHQNzN_FBw5d/exec';
...
$formData = array(
    ...
    'Campaign' => 'Corporate Video Landing Page',
