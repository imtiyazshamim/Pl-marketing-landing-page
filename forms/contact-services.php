...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "Brand service Landing page - ".$from_name;
    ...
    $message .= "service: " . clean_input($_POST['service']) . "\n";
...
function sendDataToGoogleSheet($formData) {
    $url = 'https://script.google.com/macros/s/AKfycby6MCVkEwll_KoxFMzFJoCVxBGvRGTKHqJFdOPLuj87m4IMSxeO5M16wHphf6r8R2cd/exec';
...
$formData = array(
    ...
    'Campaign' => 'PL Service Landing Page',
